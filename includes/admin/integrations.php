    ...
    <div class="row">
        ...
        <div class="zeus-container">
            ...
            <div class="zeus-block zeus-setting">
                ...
                <p class="description"><?php echo sprintf( esc_html__( 'Used for the MailChimp widget. %1$sFollow this article%2$s to get your API Key.', 'zeus-elementor' ), '<a href="#" target="_blank">', '</a>' ); ?></p>
            </div>
            ...
            <div class="zeus-block zeus-setting">
                ...
                <p class="description"><?php echo sprintf( esc_html__( 'Used for the Google Map widget. %1$sFollow this article%2$s to get your API Key.', 'zeus-elementor' ), '<a href="#" target="_blank">', '</a>' ); ?></p>
            </div>
